...
Neither exists yet. The repo was an empty directory when this skill ran, and both files are meant to appear lazily via `/domain-modeling` — do not create them speculatively.
